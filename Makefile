...
run_day_17: # Run a solver for Day 17 solutions
	${docker_compose} exec ${docker_container} python ./src/aoc.py day17

run_day_18: # Run a solver for Day 18 solutions
	${docker_compose} exec ${docker_container} python ./src/aoc.py day18
